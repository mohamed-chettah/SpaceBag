    ...
    <div class="container border-t flex items-center justify-center mb-4">
      <div class="copywrite">
        <p class="py-4 text-xs text-center">
          <a href="https://woonuxt.com" :title="`WooNuxt v${wooNuxtVersionInfo}`">SpageBag</a> - by
          <a href="https://scottyzen.com" title="Scott Kennedy - Web Developer" target="_blank">MC Studio</a>
        </p>
      </div>
    </div>
  </footer>
